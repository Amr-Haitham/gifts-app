...
class TextFieldWidget extends StatefulWidget {
  ...
  final bool
      enabled; //a variable to enable editing the textfield or not (why? in some areas of the app we'll need a container that looks like a text field, to show the users what they have entered, but they cannot modify it)
          ...
          focusedBorder: widget.focusBorder ??
              OutlineInputBorder(
                borderSide: BorderSide(
                    color: widget.focusColor ?? Colors.black, width: 0),
                borderRadius: BorderRadius.all(
                  Radius.circular(widget.borderRadius ?? 12),
                ),
              ),
